...
export default async function RewardsPage() {
  ...
  return <main className="mx-auto max-w-6xl px-4 py-10 md:px-6 md:py-14"><RewardCenter actorId={actor.id} initialCenter={center} leaderboard={leaderboard} profile={profile ?? undefined} /></main>;
}
