    ...
    <header className="sticky top-0 z-20 border-b border-border/80 bg-background/92 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-2 px-4 sm:gap-4 md:gap-6 md:px-6">
        ...
        <nav aria-label="主导航" className="ml-auto flex items-center gap-1 text-sm font-medium">
          ...
          <Link href="/workbench" aria-label="交易工作台" className="hidden min-h-11 min-w-11 items-center justify-center gap-2 rounded-lg px-2 py-2 text-muted-foreground hover:bg-muted hover:text-foreground md:flex lg:px-3">
          ...
          <Link href="/leaderboard" aria-label="交易收益排行榜" className="hidden min-h-11 min-w-11 items-center justify-center gap-2 rounded-lg px-2 text-muted-foreground hover:bg-muted hover:text-foreground md:flex lg:px-3">
