...
export function RewardCenter({ actorId, initialCenter, leaderboard }: { actorId: string; initialCenter: RewardCenterValue; leaderboard: RewardLeaderboardEntry[] }) {
