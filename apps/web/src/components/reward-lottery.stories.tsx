...
const meta = {
  ...
  args: {
    ...
    initialState: {
      ...
      prizes: [
        { id: "prize-1", name: "研究称号", summary: "由管理员人工发放", image_url: null, probability_bps: 250, stock_total: 100, stock_remaining: 83, fulfillment_type: "manual", reward_points: null },
