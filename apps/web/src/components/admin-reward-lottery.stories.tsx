...
const meta = {
  ...
  args: {
    ...
    initialStore: {
      ...
      prizes: [{ id: "prize-1", campaign_id: "campaign-1", name: "研究积分 50", summary: "中奖自动到账", image_url: null, probability_bps: 250, stock_total: 100, stock_remaining: 100, fulfillment_type: "points", reward_points: 50, sort_order: 10, created_at: "2026-09-01T00:00:00.000Z", updated_at: "2026-09-01T00:00:00.000Z" }],
      draws: [],
    },
  },
